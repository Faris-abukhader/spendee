...
export default function Home({transactions}) {
  ...
  const calculateTransactionAmount = ()=>{ 
    ...
    setTransactionAmount(TemptransactionAmount)
  }
  ...
  return (
    <ClientLayout>
      <div className='pt-4'>
        ...
        <h3>Wallets</h3>
        <div className='ps-3'>
          <WalletCard transactions={transactionList} />
        </div>
        <div style={{ marginTop: '50px' }} className='row align-items-between justify-content-center pt-4 px-0'>
              ...
              <div className='col-lg-6 col-md-6 col-sm-6 col-xs-12'>
                <DateRangePicker updateNewData={updateData} />
              </div>
            </div>
          ...
          <>
            <div className='row'>
              <div className='col-lg-6 col-md-6 col-sm-12'>
                <DoughnutChart transactions={transactionList} />
              </div>
              <div className='col-lg-6 col-md-6 col-sm-12'>
