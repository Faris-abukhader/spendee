...
export default function AddNewBudgetCard() {
  ...
  return (
      <>
    <div className="col-lg-4 col-md-3 col-sm-6 col-xs-12 p-2 text-center py-5" style={{background:'white',borderRadius:'8px',boxShadow:'2px 4px 8px 2px rgba(34,41,47,.12)!important'}}>
